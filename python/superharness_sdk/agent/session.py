...
Session management for SuperHarness SDK.
...
Example:
    ...
    >>> session.save("~/.superharness/sessions/my-session.json")
    >>> session2 = Session.load("~/.superharness/sessions/my-session.json")
"""
...
class Session:
    ...
    def get_default_session_dir() -> Path:
        ...
        Returns:
            Path to ~/.superharness/sessions/
        """
        home = Path.home()
        return home / ".superharness" / "sessions"
